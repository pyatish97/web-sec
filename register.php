...
{
   font-size:250%;
   font-family: Sofia Pro,sans-serif,tag;
}
.txt
{
...
{
   font-size:125%;
   font-family:Comic Sans MS,sans-serif,txt;
   color:#696969;
} 
...
@media (max-width:320px){                                  
	...
	.user {
		background: url(icons.png) no-repeat 12px 4px;
	}
	.lock {
		background: url(icons.png) no-repeat -20px 3px;
	}
	.p-container .checkbox {
	float: none;
	text-align: center;
...
<body>
				...
				<form class="form-horizontal" method="post" action="login_action.php">
                                        ...
                                        <div class="txt">
                                        <h2><center>AT YOUR SERVICE FOR REGISTRATION</center></h2>
					</div>
					<li>
						<input type="text" class="text" value="FIRST NAME" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'FIRST NAME';}" ></li>
					<li>
						<input type="text" class="text" value="LAST NAME" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'LAST NAME';}" ></li>
					<li>
						<input type="email" class="text" value="EMAIL" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'EMAIL';}" ></li>
          <li>
